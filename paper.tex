...
screen; this is the content of Lemma~\ref{lem:calib}. A fixed $M$ must dominate it: setting $M$ at the
mean residual violation ($0.043$) undercovers, while nominal coverage is reached near the ninety-fifth
percentile ($0.057$) and well below the maximum ($0.112$). The recommendation follows: calibrate $M$ to
the residual violation of a typical selected set, not its average, and treat it as a floor.
