...
We make four contributions. \emph{First, identification.} Changing the target to the credible
...
sensitivity analysis. \emph{Fourth, evidence.} Simulations trace the method's advantage across the
...
Two questions remain open. The first is the finite-sample coverage of a single interval chosen by a
hard-thresholded rule, as against the both-intervals report we recommend, whose honesty does not depend on
the choice. The second is whether the credible-subpopulation weighting is optimal in a decision-theoretic
sense, analogous to the variance-minimizing overlap weights of \citet{crump2009}, rather than merely
credible; a weighting that traded a little credibility for a large reduction in the variance cost
$\Delta\mathrm{Var}$ might dominate the flat screen, and characterizing it would complete the analogy to the
limited-overlap literature from which the approach borrows.
