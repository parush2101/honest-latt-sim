...
study, all cohorts (pooled ATT) versus the credible subpopulation (LATT) at the illustrative threshold
$c\approx0.03$, with $95\%$ bands. (c) The credibility path: the LATT as the screen threshold $c$ is
relaxed, near zero across the flat-pre-trend cohorts and rising toward the pooled ATT only as trending
cohorts are readmitted.}
\label{fig:frack}
\end{figure}
