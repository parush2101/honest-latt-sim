...
Screen: curvature (max |pre-period second difference|, via L2.max_abs_second_diff), the same
functional the SD(M) FLCI bounds. Thresholds c_sel are on the curvature scale.
"""
import numpy as np
...
if __name__=="__main__":
    ...
    for C_marg,c_sel in [(0.10,0.25),(0.10,0.22)]:   # curvature-scale thresholds (looser, tighter)
